...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(850, 250)
        MainWindow.setMinimumSize(QtCore.QSize(850, 250))
        MainWindow.setMaximumSize(QtCore.QSize(850, 250))
        ...
        self.label.setMinimumSize(QtCore.QSize(450, 35))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        ...
        self.label_6.setMinimumSize(QtCore.QSize(450, 35))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Расчёт учетных ставок, эквивалентных процентным ставкам"))
        self.label_11.setText(_translate("MainWindow", "<html><head/><body><p>Расчёт учетных ставок, эквивалентных процентным ставкам </p></body></html>"))
        self.label.setText(_translate("MainWindow", "<html><head/><body><p>Введите размер годовой процентной ставки: </p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p>i</p></body></html>"))
